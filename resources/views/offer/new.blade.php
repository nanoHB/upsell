                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right" name="start-time" id="start-time" required>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right" name="end-time" id="end-time" required>
                                    <div class="invalid-feedback">
